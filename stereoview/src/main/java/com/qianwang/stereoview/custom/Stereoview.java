package com.qianwang.stereoview.custom;
...
public class StereoView extends ViewGroup {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        Log.i("520it", "" + "****************   dispatchTouchEvent  *******************");
        float x = ev.getX();
        float y = ev.getY();
        switch (ev.getAction()) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.i("520it", "" + "*****************  onInterceptTouchEvent  ******************");
        Log.i("520it", "isSliding" + "***********************************"+isSliding);
        return isSliding;
    }
